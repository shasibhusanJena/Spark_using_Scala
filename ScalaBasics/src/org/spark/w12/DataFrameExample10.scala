...
object DataFrameExample10 extends App {
 ...
 * we are not storing status in the file as the file name itself is with status type  
 ...
 * */   
  ...
  .option("maxRecordsPerFile", 2000)
  .option("path","./files/w11/output1").save()
